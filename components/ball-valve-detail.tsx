...
export function BallValveDetail() {
  const [quantity, setQuantity] = useState(1)
  const [selectedImage, setSelectedImage] = useState(0)

  const images = [
    "/stainless-steel-ball-valve-assembly-floating-dark-.jpg",
    "/ball-valve-quarter-turn-handle-industrial-lighting.jpg",
    "/ball-valve-internal-ball-and-seal-close-up.jpg",
    "/ball-valve-tri-clamp-connection-detail.jpg",
  ]
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
      ...
      <nav className="flex items-center gap-2 text-sm text-muted-foreground font-mono mb-8">
        ...
        <span>/</span>
        <span className="text-foreground">Ball Valve Assembly</span>
      </nav>
      ...
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-6">
          <div>
            <h1 className="text-4xl font-bold mb-2 tracking-tight">Ball Valve Assembly</h1>
            <p className="text-muted-foreground font-mono text-sm">SKU: BVA-3-304</p>
          </div>

          <div className="text-3xl font-bold text-primary">$295.00</div>

          <p className="text-muted-foreground leading-relaxed">
            Sanitary ball valve with quarter-turn operation for reliable on/off flow control. Full-port design minimizes
            pressure drop. 304 stainless steel construction with PTFE seals. Ideal for winery transfer lines and
            processing systems.
          </p>
          ...
          <div className="border-t border-border pt-6">
            ...
            <table className="w-full font-mono text-sm">
              <tbody className="divide-y divide-border">
                ...
                <tr>
                  <td className="py-2 text-muted-foreground">Port Type</td>
                  <td className="py-2 text-right font-medium">Full Port</td>
                </tr>
                <tr>
                  <td className="py-2 text-muted-foreground">Seal Material</td>
                  <td className="py-2 text-right font-medium">PTFE (Food-Grade)</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="py-2 text-muted-foreground">Operation</td>
                  <td className="py-2 text-right font-medium">Quarter-Turn Manual</td>
                </tr>
              </tbody>
            </table>
          </div>
