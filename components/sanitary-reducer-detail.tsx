...
export function SanitaryReducerDetail() {
  const [quantity, setQuantity] = useState(1)
  const [selectedImage, setSelectedImage] = useState(0)

  const images = [
    "/stainless-steel-sanitary-reducer-fitting-dark-back.jpg",
    "/sanitary-reducer-concentric-transition-industrial-.jpg",
    "/sanitary-reducer-tri-clamp-ferrules-both-ends.jpg",
    "/sanitary-reducer-interior-smooth-bore-detail.jpg",
  ]
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
      ...
      <nav className="flex items-center gap-2 text-sm text-muted-foreground font-mono mb-8">
        ...
        <span>/</span>
        <span className="text-foreground">Sanitary Reducer</span>
      </nav>
      ...
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-6">
          <div>
            <h1 className="text-4xl font-bold mb-2 tracking-tight">Sanitary Reducer</h1>
            <p className="text-muted-foreground font-mono text-sm">SKU: RED-3-2-316L</p>
          </div>

          <div className="text-3xl font-bold text-primary">$125.00</div>

          <p className="text-muted-foreground leading-relaxed">
            Concentric sanitary reducer for transitioning between pipe sizes. Smooth internal bore prevents particle
            accumulation. 316L stainless steel with tri-clamp connections on both ends. Essential for flexible system
            design.
          </p>
            ...
            <table className="w-full font-mono text-sm">
              <tbody className="divide-y divide-border">
                ...
                <tr>
                  ...
                  <td className="py-2 text-right font-medium">3" x 2"</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="py-2 text-muted-foreground">Reducer Type</td>
                  <td className="py-2 text-right font-medium">Concentric</td>
                </tr>
                <tr>
                  <td className="py-2 text-muted-foreground">Interior Finish</td>
                  <td className="py-2 text-right font-medium">Smooth Bore Polish</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="py-2 text-muted-foreground">Orientation</td>
                  <td className="py-2 text-right font-medium">Bidirectional</td>
                </tr>
              </tbody>
            </table>
          </div>
