...
export function PressureReliefValveDetail() {
  const [quantity, setQuantity] = useState(1)
  const [selectedImage, setSelectedImage] = useState(0)

  const images = [
    "/stainless-steel-pressure-relief-valve-industrial-l.jpg",
    "/pressure-relief-valve-spring-mechanism-industrial-.jpg",
    "/pressure-relief-valve-npt-threaded-connection-deta.jpg",
    "/pressure-relief-valve-adjustment-knob-close-up.jpg",
  ]
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
      ...
      <nav className="flex items-center gap-2 text-sm text-muted-foreground font-mono mb-8">
        ...
        <span>/</span>
        <span className="text-foreground">Pressure Relief Valve</span>
      </nav>
      ...
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-6">
          <div>
            <h1 className="text-4xl font-bold mb-2 tracking-tight">Pressure Relief Valve</h1>
            <p className="text-muted-foreground font-mono text-sm">SKU: PRV-2-316</p>
          </div>

          <div className="text-3xl font-bold text-primary">$320.00</div>

          <p className="text-muted-foreground leading-relaxed">
            Heavy-duty pressure relief valve designed for tank and vessel protection. Spring-loaded mechanism with
            adjustable pressure setting. 316 stainless steel construction ensures durability and corrosion resistance in
            ...
            <table className="w-full font-mono text-sm">
              <tbody className="divide-y divide-border">
                ...
                <tr>
                  ...
                  <td className="py-2 text-right font-medium">NPT Threaded</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="py-2 text-muted-foreground">Adjustable Range</td>
                  <td className="py-2 text-right font-medium">50-300 PSI</td>
                </tr>
                <tr>
                  <td className="py-2 text-muted-foreground">Mechanism</td>
                  <td className="py-2 text-right font-medium">Spring-Loaded</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="py-2 text-muted-foreground">Certification</td>
                  <td className="py-2 text-right font-medium">ASME Certified</td>
                </tr>
              </tbody>
            </table>
          </div>
