...
export function ButterflyValveDetail() {
  const [quantity, setQuantity] = useState(1)
  const [selectedImage, setSelectedImage] = useState(0)

  const images = [
    "/stainless-steel-butterfly-valve-isometric-floating.jpg",
    "/butterfly-valve-lever-handle-close-up-industrial-l.jpg",
    "/butterfly-valve-disc-and-seal-industrial-photograp.jpg",
    "/butterfly-valve-tri-clamp-connection-detail.jpg",
  ]
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
      ...
      <nav className="flex items-center gap-2 text-sm text-muted-foreground font-mono mb-8">
        ...
        <span>/</span>
        <span className="text-foreground">Sanitary Butterfly Valve</span>
      </nav>
      ...
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-6">
          <div>
            <h1 className="text-4xl font-bold mb-2 tracking-tight">Sanitary Butterfly Valve</h1>
            <p className="text-muted-foreground font-mono text-sm">SKU: BV-2-316L</p>
          </div>

          <div className="text-3xl font-bold text-primary">$245.00</div>

          <p className="text-muted-foreground leading-relaxed">
            Premium sanitary butterfly valve engineered for precise flow control in winery and food processing
            applications. Features 316L stainless steel construction with food-grade EPDM seal and lever handle for
            manual operation.
          </p>
          ...
          <div className="border-t border-border pt-6">
            ...
            <table className="w-full font-mono text-sm">
              <tbody className="divide-y divide-border">
                ...
                <tr>
                  <td className="py-2 text-muted-foreground">Handle Type</td>
                  <td className="py-2 text-right font-medium">Manual Lever</td>
                </tr>
                <tr>
                  <td className="py-2 text-muted-foreground">Temperature Range</td>
                  <td className="py-2 text-right font-medium">-20°F to 250°F</td>
                </tr>
                <tr>
                  <td className="py-2 text-muted-foreground">Finish</td>
                  <td className="py-2 text-right font-medium">Sanitary Polish</td>
                </tr>
              </tbody>
            </table>
          </div>
